...
class Stage {
    constructor({ canvasRes, osCanvasRes, dpr = 2 }, callback) {
...
export { Circle, EventNames, Path, Polygon, Stage, createId, createOnceId, guideRenderFunc, idToRgba, rgbaToId };
